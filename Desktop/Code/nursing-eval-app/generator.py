...
def build_user_prompt(name: str, role: str, level: str, description: str, num_paragraphs: int) -> str:
    return f"""Generate a {num_paragraphs}-paragraph annual performance evaluation using the framework above.
...
def generate_evaluation(name: str, role: str, level: str, description: str, num_paragraphs: int) -> str:
    message = client.messages.create(
        ...
        messages=[
            {
                "role": "user",
                "content": build_user_prompt(name, role, level, description, num_paragraphs)
            }
        ]
    )
