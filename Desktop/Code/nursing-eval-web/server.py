...
1. Communication & Reception — answers and routes calls promptly and courteously; greets patients, families, and staff professionally; acts as an effective information hub for the unit
2. Order Processing & Chart Management — transcribes/processes orders accurately and in a timely way; assembles, maintains, and audits charts; keeps records complete and current
3. Clerical Accuracy & Documentation — enters data correctly; minimizes errors; follows documentation standards and corrects discrepancies proactively
...
5. Customer Service & Interpersonal Skills — stays calm and helpful under pressure; de-escalates frustrated visitors; represents the unit well to other departments
6. Teamwork & Collaboration — supports nurses and providers; shares information clearly during handoffs; pitches in during busy periods
7. Confidentiality & Compliance — consistently protects PHI and follows HIPAA and facility privacy policies; handles sensitive information discreetly
8. Systems & Technology Proficiency — uses the EHR, telephone/paging, and office systems competently; adapts to system changes and updates
9. Dependability & Initiative — reliable attendance and punctuality; takes ownership of tasks; identifies and solves problems without prompting
